...
export const fetchCoffeeStores = async (latLong = '47.69945652066026,17.623320981826044' , limit=30) => {
    ...
    const options = {
      ...
      return data.results.map( (result,idx) =>{
        ...
        return{
          ...
          name: result.name,
          locality: result.location.locality?.length > 0 ? result.location.locality : "",
